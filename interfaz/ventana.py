...
def abrir_f1(raiz):
    ...
    _label(v, "Longitud deseada:").grid(row=0, column=0, padx=14, pady=12, sticky="w")
    e_long = _entry(v)
...
def abrir_f3(raiz):
    ...
    _label(v, "Longitud deseada (mín 6):").grid(row=0, column=0, padx=14, pady=12, sticky="w")
    e_long = _entry(v)
    e_long.grid(row=0, column=1, padx=14, pady=12, sticky="ew")
...
def abrir_f4(raiz):
    ...
    _label(v, "Longitud deseada (mín 10):").grid(row=0, column=0, padx=14, pady=12, sticky="w")
    e_long = _entry(v)
    e_long.grid(row=0, column=1, padx=14, pady=12, sticky="ew")
...
def abrir_f5(raiz):
    ...
    _label(v, "Frase base (mín 5 palabras):").grid(row=0, column=0, padx=14, pady=10, sticky="w")
    e_frase = _entry(v)
    e_frase.grid(row=0, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Símbolo final:").grid(row=1, column=0, padx=14, pady=10, sticky="w")
    e_simbolo = _entry(v)
...
def abrir_f7(raiz):
    ...
    _label(v, "Cantidad de palabras (mín 3):").grid(row=0, column=0, padx=14, pady=10, sticky="w")
    e_cant = _entry(v)
    e_cant.grid(row=0, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Separador (- _ ! #):").grid(row=1, column=0, padx=14, pady=10, sticky="w")
    e_sep = _entry(v)
    e_sep.grid(row=1, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Número final:").grid(row=2, column=0, padx=14, pady=10, sticky="w")
    e_num = _entry(v)
...
def abrir_f8_f9(raiz):
    ...
    _label(v, "Contraseña a evaluar:").grid(row=0, column=0, padx=14, pady=12, sticky="w")
    e_pwd = _entry(v)
    e_pwd.grid(row=0, column=1, padx=14, pady=12, sticky="ew")

    _label(v, "Patrones (F9):").grid(row=2, column=0, padx=14, pady=8, sticky="w")
    lbl_patrones = tk.Label(v, text="—", bg=BG_SUB, fg=TEXTO2, font=("Helvetica", 11, "bold"))
    lbl_patrones.grid(row=2, column=1, padx=14, sticky="w")

    _label(v, "Clasificación (F8):").grid(row=3, column=0, padx=14, pady=8, sticky="w")
    lbl_clase = tk.Label(v, text="—", bg=BG_SUB, fg="#64FF9E", font=("Helvetica", 11, "bold"))
    ...
    _btn(v, "Evaluar Contraseña", ejecutar).grid(row=1, column=0, columnspan=2, pady=10)
...
def abrir_f10(raiz):
    ...
    _label(v, "Contraseña objetivo (2–5 caracteres):").grid(row=0, column=0, padx=14, pady=10, sticky="w")
    e_obj = _entry(v)
    e_obj.grid(row=0, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Caracteres a probar:").grid(row=1, column=0, padx=14, pady=10, sticky="w")
    e_chars = _entry(v)
    e_chars.insert(0, "0123456789")
    e_chars.grid(row=1, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Longitud máxima:").grid(row=2, column=0, padx=14, pady=10, sticky="w")
    e_max = _entry(v)
    e_max.insert(0, "4")
    ...
    def ejecutar():
        ...
        try:
            ...
            if len(obj) < 2 or len(obj) > 5:
                ...
                return
            resultado = ataques.simulacion_fuerza_bruta_recursiva(obj, e_chars.get(), lon_max)
    ...
    _btn(v, "Iniciar Simulación", ejecutar, color=ROJO).grid(row=3, column=0, columnspan=2, pady=10)
...
def abrir_f13(raiz):
    ...
    _label(v, "Frase (mín 3 palabras):").grid(row=0, column=0, padx=14, pady=10, sticky="w")
    e_frase = _entry(v)
    e_frase.grid(row=0, column=1, padx=14, pady=10, sticky="ew")

    _label(v, "Número final:").grid(row=1, column=0, padx=14, pady=10, sticky="w")
    e_numero = _entry(v)
